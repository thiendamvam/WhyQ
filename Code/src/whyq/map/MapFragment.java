...
//		btnDirection = (Button)v.findViewById(R.id.btnDone);
...
//	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		super.onCreate(savedInstanceState);
		View v = inflater.inflate(R.layout.maps_main, container, false);

		// Loader image - will be shown before loading image
		// ImageLoader class instance
		tvHeader = (TextView)v.findViewById(R.id.tvHeaderTitle);
		tvHeader.setText("Map");
		
		v.findViewById(R.id.btnDistance).setVisibility(View.INVISIBLE);
		ImageLoader imgLoader = new ImageLoader(WhyqApplication
				.Instance().getApplicationContext());
		int loader = R.drawable.ic_launcher;
//		ImageView icon_hotel = (ImageView) findViewById(R.id.icon_hotel);
