...
import whyq.paypal.http.AsyncConnection;
import whyq.paypal.http.AsyncConnection.AsyncConnectionListener;
 ...
 * 
 */
public class LoginPaypalActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		progress = ProgressDialog.show(LoginPaypalActivity.this,
