...
public class WhyqListActivity extends FragmentActivity implements Login_delegate, OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		progressBar = new ProgressBar(WhyqListActivity.this);
		isAddHeader = true;
		...
		utils.writeLogFile(WhyqListActivity.this.getIntent());
    	dialog = ProgressDialog.show(getParent(), "", "progressing...",
    			true);
    	showProgress();
    	Intent intent = new Intent(WhyqListActivity.this, WhyqLogout.class);
